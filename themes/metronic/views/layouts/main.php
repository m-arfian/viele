...
<html lang="en" class="no-js">
    ...
    <head>
        ...
        <link href="<?php echo Yii::app()->theme->baseUrl ?>/assets/global/plugins/gritter/css/jquery.gritter.css" rel="stylesheet" type="text/css"/>
        <link href="<?php echo Yii::app()->theme->baseUrl ?>/assets/global/plugins/bootstrap-datepicker/css/datepicker.css">
        <link href="<?php echo Yii::app()->theme->baseUrl ?>/assets/global/plugins/fullcalendar/fullcalendar/fullcalendar.css" rel="stylesheet" type="text/css"/>
        <!-- END PAGE LEVEL PLUGIN STYLES -->
        <!-- BEGIN PAGE STYLES -->
        <link href="<?php echo Yii::app()->theme->baseUrl ?>/assets/admin/pages/css/tasks.css" rel="stylesheet" type="text/css"/>
        <!-- END PAGE STYLES -->
        <!-- BEGIN THEME STYLES -->
        ...
        <link href="<?php echo Yii::app()->theme->baseUrl ?>/assets/admin/layout/css/themes/default.css" rel="stylesheet" type="text/css" id="style_color"/>
    ...
    <body class="page-header-fixed page-quick-sidebar-over-content">
                ...
                <div class="top-menu">
                    <ul class="nav navbar-nav pull-right">
                                    ...
                                    <ul class="dropdown-menu-list scroller" style="height: 250px;">
                                        <li>
                                            <a href="inbox.html?a=view">
                                                <span class="photo">
                                                    <img src="<?php echo Yii::app()->theme->baseUrl ?>/assets/admin/layout/img/avatar2.jpg" alt=""/>
                                                </span>
                                                <span class="subject">
                                                    <span class="from">
                                                        Lisa Wong </span>
                                        ...
                                        <li>
                                            <a href="inbox.html?a=view">
                                                <span class="photo">
                                                    <img src="<?php echo Yii::app()->theme->baseUrl ?>/assets/admin/layout/img/avatar3.jpg" alt=""/>
                                                </span>
                                                <span class="subject">
                                                    <span class="from">
                                                        Richard Doe </span>
                                        ...
                                        <li>
                                            <a href="inbox.html?a=view">
                                                <span class="photo">
                                                    <img src="<?php echo Yii::app()->theme->baseUrl ?>/assets/admin/layout/img/avatar1.jpg" alt=""/>
                                                </span>
                                                <span class="subject">
                                                    <span class="from">
                                                        Bob Nilson </span>
                        ...
                        <li class="dropdown dropdown-user">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                <img alt="" class="img-circle" src="<?php echo Yii::app()->theme->baseUrl ?>/assets/admin/layout/img/avatar3_small.jpg"/>
                                <span class="username">
                                    Bob </span>
        ...
        <div class="page-container">
            ...
            <?php $this->renderPartial('//layouts/part/_sidebar_admin') ?>
                                ...
                                <div class="page-quick-sidebar-chat-users" data-rail-color="#ddd" data-wrapper-class="page-quick-sidebar-list">
                                    ...
                                    <ul class="media-list list-items">
                                        <li class="media">
                                            ...
                                            <img class="media-object" src="<?php echo Yii::app()->theme->baseUrl ?>/assets/admin/layout/img/avatar3.jpg" alt="...">
                                        ...
                                        <li class="media">
                                            <img class="media-object" src="<?php echo Yii::app()->theme->baseUrl ?>/assets/admin/layout/img/avatar1.jpg" alt="...">
                                            <div class="media-body">
                                        ...
                                        <li class="media">
                                            ...
                                            <img class="media-object" src="<?php echo Yii::app()->theme->baseUrl ?>/assets/admin/layout/img/avatar4.jpg" alt="...">
                                            <div class="media-body">
                                        ...
                                        <li class="media">
                                            <img class="media-object" src="<?php echo Yii::app()->theme->baseUrl ?>/assets/admin/layout/img/avatar2.jpg" alt="...">
                                            <div class="media-body">
                                    ...
                                    <ul class="media-list list-items">
                                        <li class="media">
                                            ...
                                            <img class="media-object" src="<?php echo Yii::app()->theme->baseUrl ?>/assets/admin/layout/img/avatar6.jpg" alt="...">
                                            <div class="media-body">
                                        ...
                                        <li class="media">
                                            ...
                                            <img class="media-object" src="<?php echo Yii::app()->theme->baseUrl ?>/assets/admin/layout/img/avatar7.jpg" alt="...">
                                            <div class="media-body">
                                        ...
                                        <li class="media">
                                            <img class="media-object" src="<?php echo Yii::app()->theme->baseUrl ?>/assets/admin/layout/img/avatar8.jpg" alt="...">
                                            <div class="media-body">
                                        ...
                                        <li class="media">
                                            ...
                                            <img class="media-object" src="<?php echo Yii::app()->theme->baseUrl ?>/assets/admin/layout/img/avatar9.jpg" alt="...">
                                            <div class="media-body">
                                        ...
                                        <li class="media">
                                            <img class="media-object" src="<?php echo Yii::app()->theme->baseUrl ?>/assets/admin/layout/img/avatar10.jpg" alt="...">
                                            <div class="media-body">
                                        ...
                                        <li class="media">
                                            ...
                                            <img class="media-object" src="<?php echo Yii::app()->theme->baseUrl ?>/assets/admin/layout/img/avatar11.jpg" alt="...">
                                            <div class="media-body">
                                ...
                                <div class="page-quick-sidebar-item">
                                    <div class="page-quick-sidebar-chat-user">
                                        ...
                                        <div class="page-quick-sidebar-chat-user-messages">
                                            <div class="post out">
                                                <img class="avatar" alt="" src="<?php echo Yii::app()->theme->baseUrl ?>/assets/admin/layout/img/avatar3.jpg"/>
                                                <div class="message">
                                            ...
                                            <div class="post in">
                                                <img class="avatar" alt="" src="<?php echo Yii::app()->theme->baseUrl ?>/assets/admin/layout/img/avatar2.jpg"/>
                                                <div class="message">
                                                    <span class="arrow"></span>
        ...
        <![endif]-->
        <!--<script src="<?php echo Yii::app()->theme->baseUrl ?>/assets/global/plugins/jquery-1.11.0.min.js" type="text/javascript"></script>-->
        ...
        <script src="<?php echo Yii::app()->theme->baseUrl ?>/assets/global/plugins/flot/jquery.flot.min.js" type="text/javascript"></script>
        <script src="<?php echo Yii::app()->theme->baseUrl ?>/assets/global/plugins/flot/jquery.flot.resize.min.js" type="text/javascript"></script>
        <script src="<?php echo Yii::app()->theme->baseUrl ?>/assets/global/plugins/flot/jquery.flot.categories.min.js" type="text/javascript"></script>
        <script src="<?php echo Yii::app()->theme->baseUrl ?>/assets/global/plugins/jquery.pulsate.min.js" type="text/javascript"></script>
        ...
        <script src="<?php echo Yii::app()->theme->baseUrl ?>/assets/global/plugins/fullcalendar/fullcalendar/fullcalendar.min.js" type="text/javascript"></script>
        <script src="<?php echo Yii::app()->theme->baseUrl ?>/assets/global/plugins/jquery-easypiechart/jquery.easypiechart.min.js" type="text/javascript"></script>
        <script src="<?php echo Yii::app()->theme->baseUrl ?>/assets/global/plugins/jquery.sparkline.min.js" type="text/javascript"></script>
        <script src="<?php echo Yii::app()->theme->baseUrl ?>/assets/global/plugins/gritter/js/jquery.gritter.js" type="text/javascript"></script>
        ...
        <script src="<?php echo Yii::app()->theme->baseUrl ?>/assets/admin/pages/scripts/tasks.js" type="text/javascript"></script>
