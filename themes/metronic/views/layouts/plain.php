...
<html lang="en" >
    ...
    <head>
        ...
        <link href="<?php echo Yii::app()->theme->baseUrl ?>/assets/admin/pages/css/login.css" rel="stylesheet" type="text/css"/>
    ...
    <script src="<?php echo Yii::app()->theme->baseUrl ?>/assets/admin/pages/scripts/login.js" type="text/javascript"></script>
    <!-- END PAGE LEVEL SCRIPTS -->
    <script>
